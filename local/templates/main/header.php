...
<head>
    ...
    $APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/assets/css/pe-icon-7-stroke.css");
    $APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/assets/css/animate.min.css");
    $APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/assets/css/swiper-bundle.min.css");
    $APPLICATION->SetAdditionalCSS(SITE_TEMPLATE_PATH."/assets/css/venobox.css");
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="<?= SITE_TEMPLATE_PATH?>/assets/images/product-image/1.webp" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="<?= SITE_TEMPLATE_PATH?>/assets/images/product-image/2.webp" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="<?= SITE_TEMPLATE_PATH?>/assets/images/product-image/3.webp" alt="Cart product Image"></a>
                        <div class="content">
