...
<div class="mb-4">
	...
	?>
	<div class="row">
        <div class="col-4"><form action="<?=POST_FORM_ACTION_URI?>" method="POST">
                <?=bitrix_sessid_post()?>
                ...
                <div class="form-group">
                    <label for="mainFeedback_phone"><?=GetMessage("MFT_PHONE")?><?
                ...
                <input type="submit" name="submit"  value="<?=GetMessage("MFT_SUBMIT")?>" class="btn btn-primary mt-2 center">
            </form></div>
    </div>
</div>
